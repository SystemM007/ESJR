...
class HTTPCache
{
	...
	public function sendCacheControl($cacheType)
	{
		switch($cacheType)
		{
			case CACHE_PUBLIC : header('Cache-Control: public'); break;
			case CACHE_PRIVATE : header('Cache-Control: private'); break;
			case CACHE_NO_CACHE : header('Cache-Control: no-cache'); break;
